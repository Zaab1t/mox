...
oiotypes=( facet klassifikation klasse bruger interessefaellesskab itsystem organisation organisationenhed organisationfunktion sag dokument tilstand indsats aktivitet loghaendelse )
